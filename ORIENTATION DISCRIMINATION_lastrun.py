...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='/Users/vineesmacbook/Desktop/PsychoPy/Orientation Discrimination/ORIENTATION DISCRIMINATION_lastrun.py',
    ...
    for thisTrial in trials:
        ...
        while continueRoutine:
            ...
            if key_resp.status == STARTED and not waitOnFlip:
                theseKeys = key_resp.getKeys(keyList=['up', 'down'], ignoreKeys=None, waitRelease=False)
