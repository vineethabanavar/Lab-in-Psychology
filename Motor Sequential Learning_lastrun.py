...
expName = 'Motor Sequential Learning'  # from the Builder filename that created this script
expVersion = ''
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='/Users/vineesmacbook/Desktop/PsychoPy/Motor Sequential Learning/Motor Sequential Learning_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    trials = data.TrialHandler2(
        ...
        extraInfo=expInfo, 
        originPath=-1, 
        trialList=data.importConditions('/Users/vineesmacbook/Downloads/sequence_cond - Sheet1.csv'), 
        seed=None, 
    )
