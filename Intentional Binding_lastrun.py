...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='/Users/vineesmacbook/Desktop/PsychoPy/Intentional Binding/Intentional Binding_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    trials = data.TrialHandler2(
        ...
        extraInfo=expInfo, 
        originPath=-1, 
        trialList=data.importConditions('Conditions for Intentional Binding-2.xlsx'), 
        seed=None, 
    )
